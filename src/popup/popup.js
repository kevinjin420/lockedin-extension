...
const SHACKLE_PATH = 'M8 11V7a4 4 0 1 1 8 0v4';
...
function updateUI() {
	...
	shackle.setAttribute('d', SHACKLE_PATH);
	shackle.style.transformOrigin = '16px 11px';
	shackle.style.transform = isEnabled ? 'rotate(0deg)' : 'rotate(30deg)';
}
